...
const roster = [
  ...
  { id: "axel", name: "Axel the Axolotl", icon: "🦎", art: "assets/characters/axel-axolotl-real.png?v=real-1", color: "#e978a7", cardBackground: "radial-gradient(circle at 15% 18%, #d7fbff 0 5%, transparent 6%), radial-gradient(circle at 75% 24%, #86ebff 0 7%, transparent 8%), linear-gradient(160deg, #5bc9e5, #2c7fc0 62%, #24529a)", attack: "Fin Flick", range: "Water Orb", special: "Bubble Whirl", speed: 5.8, power: 10, battlePortraitScale: .78 },
  { id: "hank", name: "Hank the Hippo", icon: "🦛", art: "assets/characters/hank-hippo-real.png?v=real-1", color: "#7385a4", cardBackground: "radial-gradient(ellipse at 22% 28%, #d8bb75 0 14%, transparent 15%), linear-gradient(180deg, #78c4dd 0 38%, #668f52 39% 52%, #805537 53% 100%)", attack: "Hippo Headbutt", range: "Mud Ball", special: "River Rush", speed: 4.1, power: 15, health: 115, battlePortraitScale: .64 },
  { id: "buzz", name: "Buzz the Bee", icon: "🐝", art: "assets/characters/buzz-bee-real.png?v=real-1", color: "#f2b931", cardBackground: "radial-gradient(circle at 18% 25%, #fff8a6 0 11%, transparent 12%), radial-gradient(circle at 82% 37%, #ff9fd1 0 10%, transparent 11%), linear-gradient(180deg, #77d9f0 0 53%, #63b653 54% 100%)", attack: "Stinger Jab", range: "Honey Bolt", special: "Swarm Blitz", speed: 6.8, power: 9, battlePortraitScale: .76 },
  { id: "frost", name: "Frost the Polar Bear", icon: "🐻‍❄️", art: "assets/characters/frost-polar-bear-real.png?v=real-1", color: "#8dc7df", cardBackground: "radial-gradient(circle at 76% 20%, #fff 0 10%, transparent 11%), linear-gradient(145deg, #92e5f6 0 48%, #dffaff 49% 66%, #6bb7df 67% 100%)", attack: "Polar Paw", range: "Snowball Toss", special: "Arctic Slam", speed: 4.8, power: 14, health: 110, battlePortraitScale: .66 },
  { id: "bamboo", name: "Bamboo the Panda", icon: "🐼", art: "assets/characters/bamboo-panda-real.png?v=real-1", color: "#6b7182", cardBackground: "linear-gradient(75deg, transparent 0 15%, #4e9b4d 16% 20%, transparent 21% 38%, #70ba55 39% 44%, transparent 45% 68%, #3f8848 69% 73%, transparent 74%), linear-gradient(160deg, #b6ed8b, #4f9e54 70%, #27633c)", attack: "Bamboo Bonk", range: "Bamboo Shoot", special: "Panda Roll", speed: 5.3, power: 12, battlePortraitScale: .66 },
